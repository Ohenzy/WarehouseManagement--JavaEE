    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (!action.equals(""))
            if (action.equals("add")) {
                ...
                partners.save(new Partner(Integer.parseInt(req.getParameter("id_row")),req.getParameter("nameOrg"), req.getParameter("nameDirector"), req.getParameter("address"), req.getParameter("phone"),
                        req.getParameter("email"), req.getParameter("inn"), req.getParameter("ogrn")));
            } else if (action.equals("delete")){
                partners.deleteById(Integer.parseInt(req.getParameter("id_row")));
